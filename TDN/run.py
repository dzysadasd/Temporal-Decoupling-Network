...
parser.add_argument('--model', type=str, default='TDN',
                    help='model name, options: [Autoformer, Informer, Transformer, Adaptive_fre2, CycleNet]')

# data loader
parser.add_argument('--data', type=str, default='ETTh2', help='dataset type')
parser.add_argument('--root_path', type=str, default='./datasets/ETTh2', help='root path of the data file')
...
parser.add_argument('--mode', type=int, default=5, help='1: use revin or 0: no revin')
